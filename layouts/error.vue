  ...
  <div class="h-screen w-screen bg-gray-100 flex items-center">
    ...
    >
      <div class="max-w-md">
        ...
        <p class="mb-8">
          Lekin tashvishlanmang, asosiy sahifamizdan o'zingiga kerakli
          narsalarni topishingiz mumkin.
        </p>

        <nuxt-link
          to="/"
          class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-gray-800 active:bg-blue-600 hover:bg-blue-700"
        >
